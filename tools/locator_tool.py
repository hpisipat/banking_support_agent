...
def find_nearest(user_message, persona="existing_customer",
    ...
    max_results = 3   # always show full results — feedback never reduces info
    show_tip    = feedback_style == "detailed"
    ...
    if exact_branches or exact_atms:
        ...
        return format_results(area, exact_branches, exact_atms,
                              ...
                              max_results=max_results, show_tip=show_tip)
        ...
        try:
            ...
            if ref_coords:
                ...
                return format_results(
                    area,
                    branches_with_dist[:max_results],
                    atms_with_dist[:max_results],
    ...
    return format_results(area, branches_with_dist[:max_results],
                          atms_with_dist[:max_results], search_type,
...
def format_results(area, branches, atms, search_type,
                   ...
                   mapped_to=None, max_results=3, show_tip=False):
    ...
    if search_type in ["branch", "both"] and branches:
        ...
        for i, b in enumerate(branches[:max_results], 1):
    ...
    if search_type in ["atm", "both"] and atms:
        ...
        for i, a in enumerate(display_atms[:max_results], 1):
    ...
    if show_tip and response:
        response += ("\n   💡 Tip: Carry your Aadhaar and PAN card "
                     "when visiting a branch for faster service.\n"
